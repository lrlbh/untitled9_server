...
class write_verification;
class write_verificationDefaultTypeInternal;
extern write_verificationDefaultTypeInternal _write_verification_default_instance_;
class yao;
...
namespace google {
	namespace protobuf {
		...
		template<> ::write_verification* Arena::CreateMaybeMessage<::write_verification>(Arena*);
...
class write_verification : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:write_verification) */ {
public:
	write_verification();
	virtual ~write_verification();

	write_verification(const write_verification& from);

	inline write_verification& operator=(const write_verification& from) {
		CopyFrom(from);
		return *this;
	}
#if LANG_CXX11
	write_verification(write_verification&& from) noexcept
		: write_verification() {
		*this = ::std::move(from);
	}

	inline write_verification& operator=(write_verification&& from) noexcept {
		if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
			if (this != &from) InternalSwap(&from);
		}
		else {
...
#endif
	static const ::google::protobuf::Descriptor* descriptor();
	static const write_verification& default_instance();

	static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
	static inline const write_verification* internal_default_instance() {
		return reinterpret_cast<const write_verification*>(
			&_write_verification_default_instance_);
	}
	static constexpr int kIndexInFileMessages =
		4;

	void Swap(write_verification* other);
	friend void swap(write_verification& a, write_verification& b) {
		a.Swap(&b);
	}

	// implements Message ----------------------------------------------

	inline write_verification* New() const final {
		return CreateMaybeMessage<write_verification>(NULL);
	}

	write_verification* New(::google::protobuf::Arena* arena) const final {
		return CreateMaybeMessage<write_verification>(arena);
	}
	void CopyFrom(const ::google::protobuf::Message& from) final;
	void MergeFrom(const ::google::protobuf::Message& from) final;
	void CopyFrom(const write_verification& from);
	void MergeFrom(const write_verification& from);
	void Clear() final;
	bool IsInitialized() const final;
...
private:
	...
	void SharedDtor();
	void SetCachedSize(int size) const final;
	void InternalSwap(write_verification* other);
private:
	inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
		return NULL;
	}
...
public:
	...
	// @@protoc_insertion_point(class_scope:write_verification)
private:
...
// bytes pub_key = 1;
inline void verification::clear_pub_key() {
	pub_key_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& verification::pub_key() const {
	// @@protoc_insertion_point(field_get:verification.pub_key)
	return pub_key_.GetNoArena();
}
inline void verification::set_pub_key(const ::std::string& value) {

	pub_key_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
	// @@protoc_insertion_point(field_set:verification.pub_key)
}
#if LANG_CXX11
inline void verification::set_pub_key(::std::string&& value) {

	pub_key_.SetNoArena(
		&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
	// @@protoc_insertion_point(field_set_rvalue:verification.pub_key)
}
#endif
inline void verification::set_pub_key(const char* value) {
	GOOGLE_DCHECK(value != NULL);

	pub_key_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
	// @@protoc_insertion_point(field_set_char:verification.pub_key)
}
inline void verification::set_pub_key(const void* value, size_t size) {

	pub_key_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
		::std::string(reinterpret_cast<const char*>(value), size));
	// @@protoc_insertion_point(field_set_pointer:verification.pub_key)
}
inline ::std::string* verification::mutable_pub_key() {

	// @@protoc_insertion_point(field_mutable:verification.pub_key)
	return pub_key_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* verification::release_pub_key() {
	// @@protoc_insertion_point(field_release:verification.pub_key)

	return pub_key_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void verification::set_allocated_pub_key(::std::string* pub_key) {
	if (pub_key != NULL) {
	...
	// @@protoc_insertion_point(field_set_allocated:verification.pub_key)
}

// int32 pub_key_len = 2;
inline void verification::clear_pub_key_len() {
	pub_key_len_ = 0;
}
inline ::google::protobuf::int32 verification::pub_key_len() const {
	// @@protoc_insertion_point(field_get:verification.pub_key_len)
	return pub_key_len_;
}
inline void verification::set_pub_key_len(::google::protobuf::int32 value) {

	pub_key_len_ = value;
	// @@protoc_insertion_point(field_set:verification.pub_key_len)
}
...
// bool is_pub_key = 1;
inline void write_verification::clear_is_pub_key() {
	is_pub_key_ = false;
}
inline bool write_verification::is_pub_key() const {
	// @@protoc_insertion_point(field_get:write_verification.is_pub_key)
	return is_pub_key_;
}
inline void write_verification::set_is_pub_key(bool value) {

	is_pub_key_ = value;
	// @@protoc_insertion_point(field_set:write_verification.is_pub_key)
}
